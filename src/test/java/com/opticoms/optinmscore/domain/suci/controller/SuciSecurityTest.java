...
class SuciSecurityTest {

    private static final String TENANT = "OPTC-0001/0001/01";
    private static final String BASE = "/api/v1/suci/profiles";
    private static final String CREATE_JSON = """
            {"protectionScheme":"PROFILE_A","homeNetworkPublicKeyId":1,"homeNetworkPublicKey":"pub","homeNetworkPrivateKey":"priv"}
            """;
    ...
    void operatorRole_GET_200() throws Exception {
        ...
        when(suciProfileService.list(eq(TENANT), any(Pageable.class))).thenReturn(Page.empty());
    ...
    void adminRole_POST_200() throws Exception {
        ...
        SuciProfile entity = new SuciProfile();
        when(suciProfileMapper.toEntity(any())).thenReturn(entity);
        when(suciProfileService.create(eq(TENANT), any(SuciProfile.class))).thenReturn(entity);
        when(suciProfileMapper.toResponse(any(SuciProfile.class))).thenReturn(new SuciProfileResponse());
